...
const RichTextInput = forwardRef((props, ref) => {
  ...
  const {content = '', label, height = 300} = props;
  const [
    isAttachmentModalOpened,
    {open: openImageModal, close: closeAttachmentModal},
  ] = useDisclosure(false);
    ...
    <>
      ...
      <div className={`flex flex-col`}>
        <MantineRichTextEditor
          editor={editor}
          style={{height}}
          className={`w-full [&>.mantine-TypographyStylesProvider-root]:overflow-y-auto 
                          [&>.mantine-TypographyStylesProvider-root]:h-[calc(100%-48px)]
                          [&>.mantine-TypographyStylesProvider-root>.mantine-RichTextEditor-content]:h-full
                          [&>.mantine-TypographyStylesProvider-root>.mantine-RichTextEditor-content>div]:h-full`}
        >
